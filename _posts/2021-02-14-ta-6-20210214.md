...
tags: Unity C# Shader 动画 游戏 渲染 调优 DOTS Animation Animator 3D模型 光照 后处理 抗锯齿 描边 RampTex Blinn-Phong Phong Cubemap 菲涅尔 向量 环境光 切线空间 法线贴图 AO贴图 
---
...
经过上面的一步步的学习，整个场景中对于一个模型产生光影的影响包括下面这些
...
![](../media/image/2021-02-14/01-30.png)

>扩展内容：什么是PBR？产生的背景是什么？其和OldSchool 光照模型的异同之处是什么？
...
答案在[技术美术入门课-12: https://www.bilibili.com/video/BV1DQ4y1P7wG](https://www.bilibili.com/video/BV1DQ4y1P7wG)
