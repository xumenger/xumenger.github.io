...
接下来进入Spark 的源码目录，执行sbt eclipse。Sbt 执行期间会下载Spark 所需要的所有jar 包，因此该步骤会花费很长的时间。其中有一些jar 包需要使用网络代理等方法才能下载
...
现在源码环境搭建起来了，如何在ScalaIDE 中将Spark 运行起来，然后提交一个Spark 程序之后去在ScalaIDE 中调试整个Spark 的运行流程？
