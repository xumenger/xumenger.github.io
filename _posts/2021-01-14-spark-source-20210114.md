...
>为了防止项目名可能和后续需要研究的其他开源项目冲突，所以我专门新建了一个Spark Workspace 工作空间用来管理Spark 的所有子项目！原来的工作空间 导入其他Scala 开源项目、Eclipse 导入其他Java 开源项目的时候，都可以采用这样的策略！
