---
layout: post
title: Spark Streaming 实时推荐示例
categories: 大数据之spark 大数据之flink
tags: Spark 大数据 数据处理 SparkStreaming 流计算 实时处理 Flink 窗口 时间窗口 广播 Kafka 消息队列 
---

>代码来自[《尚硅谷：基于流的实时推荐》](https://www.bilibili.com/video/BV1R4411N78S?p=55)
...
object StreamingRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 加载电影相似度矩阵数据，把它广播出去（每个Executor 上就会有一个副本，不需要每个Task 都保存一份副本了！节省内存资源！）
