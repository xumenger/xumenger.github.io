---
layout: post
title: Spark MLlib ALS 推荐系统 
categories: 大数据之spark 大数据之flink
tags: Spark 大数据 数据处理 机器学习 MLlib LFM 隐语义模型 特征矩阵 矩阵 向量余弦相似度 点乘 笛卡尔积 
---

>代码来自[《尚硅谷：基于LFM 的离线推荐》](https://www.bilibili.com/video/BV1R4411N78S?p=50)
