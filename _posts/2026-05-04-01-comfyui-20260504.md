...
desktop_extensions:
  custom_nodes: D:\Program\ComfyUI\resources\ComfyUI\custom_nodes
extra_model_paths:
  # 模型类型: 你的模型文件夹路径（冒号后必须有空格）
  checkpoints: G:\AI\ComfyUI\models
  vae: G:\AI\ComfyUI\models
  loras: G:\AI\ComfyUI\models
  controlnet: G:\AI\ComfyUI\models
  embeddings: G:\AI\ComfyUI\models
  unet: G:\AI\ComfyUI\models
  llm: G:\AI\ComfyUI\models
```
