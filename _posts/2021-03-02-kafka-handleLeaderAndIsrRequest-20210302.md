---
layout: post
title: 源码面前了无秘密【Kafka】：KafkaApis.handleLeaderAndIsrRequest
categories: 源码面前了无秘密  
tags: Java Kafka Scala JVM KafkaServer Zookeeper 分布式集群 集群 消费者 消息队列 分布式 网络编程 网络 TCP IO多路复用 分布式选举 ISR 堆外内存 RandomAccessFile 内存映射 mmap 零拷贝 高性能 
---
