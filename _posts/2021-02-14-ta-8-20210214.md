...
如图，AC 没有排序问题，AB、AD 都有明显的排序问题，比如每个角色的左手都是透掉的，而AC 是可以正常看到身体的，但是AB、AD 手透掉之后，身体也对应透掉了，不符合现实社会的常识！

![](../media/image/2021-02-14/01-42.png)

一些可用的解决方法：

* Detach，Attach 大法
* 一些情况下可用Zwrite Off 解决

>扩展：Alpha 通道预乘问题？AB、AD 的Shader 代码怎么统一？
