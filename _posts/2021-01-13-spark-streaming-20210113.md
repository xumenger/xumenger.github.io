...
val kafkaDStream: ReceiverInputDStream[(String, String)] = KafkaUtils.createStream(ssc, "kafka1:2181,kafka1:2181,kafka1:2181", "MyTopic", Map[String, Int]("MyTopic" -> 1))
```
...
//4.读取 Kafka 数据
val kafkaDStream: InputDStream[(String, String)] = KafkaUtils.createDirectStream[String, String, StringDecoder, StringDecoder](ssc, kafkaPara, Set("MyTopic"))
```
